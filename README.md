...
<br><br>
## 01. 프로젝트 개요
-  그룹 모임때 참여자들의 현재 위치에 대한 거짓말을 방지해 약속 지연을 최소화 합니다.      
  ex) “나 거의 다 왔어” (사실 이제 출발한 상태)      
-  지각 데이터를 시각화하여 재미있고 긍정적인 경쟁 문화를 형성 합니다.      
-  그룹 스케줄 관리 뿐 아니라 개인 스케줄 관리도 해주며, 알람 및 거리 정보 제공을 통해 시간 관리를 도와줍니다.       
<br><br>
