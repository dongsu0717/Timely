package com.dongsu.timely.data.receiver
...
import com.dongsu.timely.data.common.ALARM_ID
import com.dongsu.timely.data.common.ALARM_ROUTE_ID
import com.dongsu.timely.data.common.ERROR_GET_LOCATION
import com.dongsu.timely.data.common.LOADING_GET_LOCATION
import com.dongsu.timely.data.common.PERSONAL_CHANNEL_ID
import com.dongsu.timely.data.common.PERSONAL_CHANNEL_NAME
import com.dongsu.timely.data.common.PERSONAL_ROUTE_CHANNEL_DESCRIPTION
import com.dongsu.timely.data.common.PERSONAL_ROUTE_CHANNEL_ID
import com.dongsu.timely.data.common.PERSONAL_ROUTE_CHANNEL_NAME
import com.dongsu.timely.data.common.TIME_TO_ROUTE_SCHEDULE
import com.dongsu.timely.data.common.TIME_TO_SCHEDULE
import com.dongsu.timely.data.common.TMAP_MARKET_URL
import com.dongsu.timely.data.common.TMAP_PACKAGE_NAME
import com.dongsu.timely.data.common.TMAP_ROUTE_URL
import com.dongsu.timely.data.common.showToast
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private suspend fun makeRouteNotification(context: Context, scheduleTitle: String, appointmentPlace: String, destinationLatitude: Double, destinationLongitude: Double) {
        ...
        notificationManager.createNotificationChannel(channel)
        val (startLatitude, startLongitude) = getCurrentLocation(context) //왜 이거보다 getDistanceAndTime이 먼저 실행되지? 코루틴 열리는순간 밑에가 실행되네
        delay(2000)
